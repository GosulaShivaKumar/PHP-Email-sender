...
function sendEmail(string $to, string $subject, string $message, string $from = null, string $from_name = null): bool
{
    ...
    $message = str_replace(["\r", "\n"], '', $message);  // Remove carriage returns and newlines from message to avoid header injection in some cases.  Re-add them *within* the message body where needed using <br> or equivalent.
